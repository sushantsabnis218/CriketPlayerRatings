...
logo = PhotoImage(file="chahal1.png")

w1 = Label(root, image=logo,height=170).pack()

Label(root,text="\n")
Label(root, text=names[11],height='2',width='30',font=('Times',18,'bold'),bg='light cyan').pack()



for i in range(0,14):
  Label(root,text=text_var[11][i],font=('Times',10),width='40',height='2',bg='light cyan').pack()
